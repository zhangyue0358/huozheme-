...
- D-U-N-S 已获得，当前主要用于 Apple Developer Program 组织账号。Google Play 暂缓。
...
Google Play 组织开发者账号也可能使用 D-U-N-S Number。由于当前先走国内路线，Google Play 资料先保留为后续海外市场备用。
...
后续在 Apple Developer Program 组织账号里使用该编号。Google Play 暂缓。
...
- App 权限说明
- App 截图
- APK 包，部分市场也支持 AAB，但国内优先准备 APK
- 加固/安全检测报告，部分市场可能要求

建议顺序：

1. 先准备通用材料：营业执照、联系人、企业邮箱、隐私政策、用户协议、权限说明、截图、APK。
2. 准备 APP 备案。当前 App 有联网登录、用户数据和短信验证码，国内市场审核时大概率会看备案状态。
3. 准备软著或 APP 电子版权。小米等市场明确要求上架应用提供软著/APP 电子版权/软著认证三选一。
4. 注册并认证国内安卓开发者账号。
5. 按优先级提交：华为应用市场、小米应用商店、OPPO 软件商店、vivo 应用商店、荣耀应用市场、腾讯应用宝。
6. 每个市场先提交同一套包和资料，再根据驳回意见补专项材料。

建议先做华为的原因：

- 企业认证、应用创建、包体上传、隐私政策和截图流程比较完整。
- 审核反馈相对结构化，适合作为国内安卓第一轮资料校准。
- 华为通过后，能复用大部分材料到小米、OPPO、vivo、荣耀和应用宝。

## Google Play 组织账号（海外路线，暂缓）

当前不作为主线。后续如果做海外/港澳台市场，再准备：
...
3. 准备国内安卓通用材料：APP 备案、软著或 APP 电子版权、权限说明、截图和 APK。
4. 先注册华为应用市场企业开发者账号，再依次处理小米、OPPO、vivo、荣耀、应用宝。
5. 如 Apple 或国内安卓市场要求公司网站与组织域名强关联，优先把产品官网绑定到公司域名，例如 `huozhema.senbeikeji.cn`。
6. 确认审核登录方案：正式手机号验证码登录；审核环境无法收中国大陆短信时，使用“先看演示模式”兜底。
7. 账号注销路径已具备：App 内二次确认提交注销请求，后台脚本按保留期清理，并在内容保留期结束后删除 Supabase Auth 用户、清理已完成注销请求；GitHub Actions 已手动运行验证成功。
8. 正式包关闭测试账号按钮。
9. 等 EAS Android 构建额度恢复，重新打 Android preview 包；国内安卓提交前准备正式 APK。

...
- 用户能通过系统分享面板分享今日摘要或邀请文案到微信好友/朋友圈；默认不分享随笔全文、照片、好友信息和手机号。
- 公司官网 `https://huozhema.senbeikeji.cn/` 部署后，分享链接能在 Safari、Android 浏览器和微信内置浏览器打开。
...
- 隐私政策网页链接。
- 用户协议网页链接。
- 产品官网部署清单见 `PRODUCT_SITE_DEPLOYMENT.md`。
- 支持邮箱或手机号。
- 年龄分级说明。
...
- 如需一键定向分享到微信好友/朋友圈，先完成微信开放平台移动应用审核，再接原生微信 SDK；当前版本先使用系统分享面板。
- 崩溃和错误监控方案。
- 生产数据库备份策略。

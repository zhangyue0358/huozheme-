...
本文件用于 App Store Connect 和国内安卓应用市场后台复制填写。

当前路线：国内优先，不走国外。Google Play Console 暂缓，后续明确做海外市场时再恢复。
...
- Android Package：`com.huozhema.app`
- 应用分类建议：生活 / 日记 / 效率，按各市场分类口径选择最接近项
- 是否联网：是
- 登录方式：手机号验证码登录
...
本应用是轻量每日确认和生活记录工具。用户可通过手机号验证码登录，确认今天还活着，保存心情、天气氛围、随笔、照片、每日箴言和今天最想做的三件事，并通过好友手机号添加好友、戳一下和“我还活着”回馈进行轻量互动。

本应用不提供医疗、心理诊断、紧急救援或危机干预服务；好友互动仅用于轻量状态确认。

如果审核人员无法接收中国大陆手机号验证码，请点击登录页底部“先看演示模式”体验核心流程。

### 国内安卓补充资质

- APP 备案：待办理
- 软著 / APP 电子版权 / 软著认证：待办理
- 安全检测报告：按市场驳回或提交要求补
- 加固包：按市场要求决定是否提供

## Google Play Console（海外路线，暂缓）

当前不作为主线。后续如果做海外/港澳台市场，再使用本节。
...
- 手机号加好友支持默认 `+86`，并已验证 11 位手机号、`86` 前缀和 `+86` 前缀都能添加。
...
- 国内安卓路线资料已准备：APP 备案、软著或 APP 电子版权、企业开发者认证、APK。
- Google Play Console 暂缓，不作为当前提交阻塞项。
